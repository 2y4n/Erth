...
gpt2_model, gpt2_tokenizer = load_gpt2_model("fine_tuned_aragpt2_saudi_traditions")
...
#tabs
tab1, tab2 = st.tabs(["FT-AraGPT2 Text-to-text", "FT-AraGPT2 Speech-to-Text"])#, "OpenAI API"])
